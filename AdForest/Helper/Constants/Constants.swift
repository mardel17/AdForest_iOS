...
class Constants {
    struct  URL {
        static let ipAddress =  "https://ec.albelal.com/"//Enter your domain name here
    ...
    struct customCodes {
        ...
        static let purchaseCode = "04e13eb0-6469-425c-a871-4cd331af7ff4"
        static let securityCode = "p_bo4k.DL=a,sv3kX@Y"
    }
    
    
    struct LinkedInConstants {
        
        static let CLIENT_ID = "CLIENT_ID";//Enter Your LINKEDIN_CLIENT_ID here
        static let CLIENT_SECRET = "CLIENT_SECRET";//Enter Your LINKEDIN_CLIENT_SECRET here
        static let REDIRECT_URI = "REDIRECT_URI";//Enter Your LINKEDIN_REDIRECT_URL here
