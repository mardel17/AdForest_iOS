...
class UserHandler {
    ...
    //MARK:- WhizChatSendChatBoxMessage
    class func WhizChatSendChatBoxMessage(parameter: NSDictionary, success: @escaping(WhizChatMessagesBoxRoot)-> Void, failure: @escaping(NetworkError)-> Void) {
