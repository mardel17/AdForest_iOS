...
class MultiHomeViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,NVActivityIndicatorViewable, MarvelCategoryDetailDelegate,MarvelAddDetailDelegate,MarvelRelatedAddDetailDelegate,MarvelLatestAddDetailDelegate,AddDetailDelegate,LocationCategoryDelegate,BlogDetailDelegate,MarvelLocationCategoryDelegate,NearBySearchDelegate,MarvelDefVerAddDetailDelegate, SwiftyAdDelegate, GADBannerViewDelegate, BannerCategoryDetailDelegate, OpenBannerCarouselDelegate, OpenPublicProfileDelegate {
    ...
    @IBOutlet weak var tableView: UITableView!{
        didSet{
            ...
            tableView.register(UINib(nibName: "MultiSearchSectionCell", bundle: nil), forCellReuseIdentifier: "MultiSearchSectionCell")
...
//                        height = CGFloat(locationHeight) + 90
                ...
                if isShowNearby {
                    ...
                    //                        height = CGFloat(nearByColHeight) + 80
                    //
        ...
        if isAdPositionSort {
            ...
            case "featured_ads":
                ...
                if featuredAdLayout == "vertical"  {
                    if isShowFeature {
                        ...
                        cell.fromMultiHome = true
                        if cell.fromMultiHome == true {
                    ...
                    if isShowFeature {
                        let cell: MultiHomeFeatureAddTableViewCell = tableView.dequeueReusableCell(withIdentifier: "MultiHomeFeatureAddTableViewCell", for: indexPath) as! MultiHomeFeatureAddTableViewCell
                        let data = AddsHandler.sharedInstance.objHomeData
                        if let sectionTitle = data?.featuredAds.text {
                            cell.lblSectionTitle.text = sectionTitle
                        }
            ...
            case "latest_ads":
                ...
                if  latestAdLayout == "vertical"  {
                    ...
                    if isShowLatest{
                        let cell: MultiLatestAdTableViewCell  = tableView.dequeueReusableCell(withIdentifier: "MultiLatestAdTableViewCell", for: indexPath) as! MultiLatestAdTableViewCell
                        let data = AddsHandler.sharedInstance.objHomeData
                        let objData = AddsHandler.sharedInstance.objLatestAds
                        ...
                        cell.delegate = self
                        cell.dataArray = self.latestAdsArray
                        heightConstraintTitleLatestad = Int(cell.heightconstraintLatestAd.constant)
            ...
            case "sliders":
                if sliderAdsLayout == "vertical"  {
                    ...
                    let cell: MultiAdsTableViewCell  = tableView.dequeueReusableCell(withIdentifier: "MultiAdsTableViewCell", for: indexPath) as! MultiAdsTableViewCell
                    let objData = dataArray[indexPath.row]
                    let data = AddsHandler.sharedInstance.objHomeData
                    ...
                    heightConstraintTitlead = Int(cell.heightConstraintMultiSliderAds.constant)
