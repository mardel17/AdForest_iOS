...
//                    self.perform(#selector(self.showAd2), with: nil, afterDelay: Double(objData!.time)!)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //Remove TextField for youtube link
        if objData.fieldType == "textfield"  && objData.hasPageNumber == "1" && objData.fieldTypeName != "ad_yvideo" {
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        ...
        if objData.fieldTypeName == "ad_yvideo" {
            height = 0
            return height
        }
