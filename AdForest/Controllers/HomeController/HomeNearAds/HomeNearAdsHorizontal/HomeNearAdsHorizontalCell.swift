//
//  HomeNearAdsHorizontalCell.swift
//  AdForest
//
...
//}
class HomeNearAdsHorizontalCell: UITableViewCell, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell: HomeNearAdsHoriCollectionCell = collectionView.dequeueReusableCell(withReuseIdentifier: "HomeNearAdsHoriCollectionCell", for: indexPath) as! HomeNearAdsHoriCollectionCell
...
class HomeNearAdsHoriCollectionCell : UICollectionViewCell {
