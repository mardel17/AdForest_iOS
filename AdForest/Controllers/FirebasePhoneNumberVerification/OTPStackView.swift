...
class OTPStackView: UIStackView {
    ...
    //Colors
    var inactiveFieldBorderColor = UIColor(white: 1, alpha: 0.3)
    var textBackgroundColor = UIColor(white: 1, alpha: 0.5)
    var activeFieldBorderColor = UIColor.white
    ...
    private final func setupTextField(_ textField: OTPTextField){
        ...
        textField.backgroundColor = Constants.hexStringToUIColor(hex: "#f6f5fa")
            //textBackgroundColor
        ...
        textField.layer.borderColor = Constants.hexStringToUIColor(hex: "#f6f5fa").cgColor
            //inactiveFieldBorderColor.cgColor
