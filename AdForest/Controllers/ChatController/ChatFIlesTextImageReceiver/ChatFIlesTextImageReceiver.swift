//
//  ChatFIlesTextImageReceiver.swift
//  AdForest
//
...
import UIKit
import CollageView
class ChatFIlesTextImageReceiver: UITableViewCell,CollageViewDelegate,CollageViewDataSource {
    ...
    @IBOutlet weak var containerImageReceiver: UIView!{
        didSet{
            containerImageReceiver.layer.cornerRadius = 5
            containerImageReceiver.layer.borderColor = UIColor.systemGreen.cgColor
            containerImageReceiver.layer.borderWidth = 5
    ...
    @IBOutlet weak var btnDownloadDocumentReceiver: UIButton!
